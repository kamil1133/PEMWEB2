        ...
        <form action="proses_registrasi.php" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="jk" id="jk_2" type="radio" class="custom-control-input" value="Anomali"
                            required="required">
                        <label for="jk_2" class="custom-control-label">Anomali</label>
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-8">
                    <?php foreach ($skills as $key => $value): ?>
                        <div class="custom-control custom-checkbox custom-control-inline">
                            <input name="skill[]" id="skill <?php echo $key ?>" type="checkbox" class="custom-control-input"
                                value="<?php echo $key ?>">
                            <label for="skill <?php echo $key ?>" class="custom-control-label">
                                <?php echo $key ?>
                            </label>
                        </div>
                    <?php endforeach; ?>
